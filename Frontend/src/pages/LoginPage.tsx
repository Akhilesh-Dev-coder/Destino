...
const LoginPage: React.FC = () => {
  ...
  const handleSubmit = () => {
    ...
    // Example: call your login API, redirect on success, etc.
  };
          ...
          <div className="space-y-6">
            ...
            <div className="flex items-center justify-between">
              <label className="flex items-center">
                <input
                  type="checkbox"
                  className="w-4 h-4 rounded border-gray-600 bg-gray-700 text-purple-500 focus:ring-purple-500 focus:ring-2"
                />
